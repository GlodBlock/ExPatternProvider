...
public class AssemblerGlassModel implements IUnbakedGeometry<AssemblerGlassModel> {
    ...
    @Override
    public @NotNull BakedModel bake(@NotNull IGeometryBakingContext context, @NotNull ModelBaker loader, @NotNull Function<Material, TextureAtlasSprite> textureGetter, @NotNull ModelState rotationContainer, @NotNull ItemOverrides overrides, ResourceLocation modelLocation) {
